...
public class QuantitydecrementFunctionalityinCartPage {

	WebDriver driver;
	JavascriptExecutor  js;
	public QuantitydecrementFunctionalityinCartPage(WebDriver remotedriver) {
		     driver=	remotedriver;
			PageFactory.initElements(remotedriver,this);
			js= (JavascriptExecutor )driver;
		}

	@FindBy(xpath="(//div[@class='_3dY_ZR'])[1]//button[1]")
